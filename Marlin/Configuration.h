...
#define STRING_CONFIG_H_AUTHOR "(Type A Machines, Series 1, 2014)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,270}  // default steps per unit for 2014 Series 1 (2GT belt Beta1)
